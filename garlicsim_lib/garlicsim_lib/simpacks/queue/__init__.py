...
`Queueing Theory`_ is the mathematical study of waiting lines, or queues. These
can be shoppers waiting in line for a cashier in a supermarket, or product
components waiting in a complex queue to be processed by different machines in
a factory. Queueing Theory has applications in diverse fields, including
telecommunications, traffic engineering, computing and the design of factories,
