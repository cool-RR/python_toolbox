Run applicationwindow.py in the src folder to see the demonstration. Then, File -> New. Press Ok. Double click on a yellow area in the seek bar to toggle playing.
