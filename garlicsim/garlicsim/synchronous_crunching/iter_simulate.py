...
from .list_simulate import _history_list_simulate
...
def iter_simulate(state, iterations, *args, **kwargs):
    ...
    (Note that in the case of history-dependent simulations, all states must be
    stored anyway, so this function will return a list.)
    '''
